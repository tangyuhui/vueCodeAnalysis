...
var _arrayAugmentations = __webpack_require__(76);

var _arrayAugmentations2 = _interopRequireDefault(_arrayAugmentations);

var _pubsub = __webpack_require__(77);

var _pubsub2 = _interopRequireDefault(_pubsub);

var _compile = __webpack_require__(78);

var compileFunc = _interopRequireWildcard(_compile);

var _Batcher = __webpack_require__(81);
...
function Vue(options) {
    ...
    this.batcher = new _Batcher2.default();
    this.path = "";
    this.$el = document.querySelector(options.el);
    this.init();
}
Vue.prototype = (0, _extends3.default)({
    init: function init() {
        ...
        (0, _defineProperty2.default)(data, key, {
            set: function set(value) {
                if (util.isObject(value)) {
                    ...
                    value.__proto__ = (0, _create2.default)(_arrayAugmentations2.default);
                }
    ...
    getData: function getData(data) {
        ...
        try {
            for (var _iterator = (0, _getIterator3.default)(dataArray), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    compileGetter: function compileGetter(path) {
        path = path.split('.');
        var boby = 'if (o !=null';
        var pathString = 'o';
        var key = void 0;
...
FakeArray.prototype = (0, _create2.default)(Array.prototype);
...
exports.default = (0, _create2.default)(FakeArray.prototype);
...
PubSub.prototype = {
    ...
    emit: function emit(eventType) {
        ...
        try {
            for (var _iterator = (0, _getIterator3.default)(eventChain), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function compileText(dom) {
    ...
    if (nodeValue.search(/^\s*$/) != -1) {
        ...
        var tokens = (0, _parse2.default)(nodeValue);
        tokens.forEach(function (token) {
            if (token.tag) {
                var el = document.createTextNode(token.value);
                var expression = token.value;
                //创建指令
                var directive = new _directive2.default(el, expression, self);
...
/***/ })
/******/ ]);
//# sourceMappingURL=vue.js.map?79a384f8e6f80a38faf4