...
var _arrayAugmentations = __webpack_require__(330);

var _arrayAugmentations2 = _interopRequireDefault(_arrayAugmentations);

var _pubsub = __webpack_require__(331);
...
function Vue(options) {
    ...
    this.event = new _pubsub2.default();
    this.path = "";
    this.init();
    this.render();
    this.originalHtml;
...
Vue.prototype = {
    ...
    convert: function convert(data, key, value, path) {
        var self = this;
        if (util.isFunction(value)) {
            var oldvalue;
            var depFun = function depFun() {
            ...
            Object.defineProperty(data, key, {
                set: function set(value) {
                    if (util.isObject(value)) {
                        ...
                        value.__proto__ = Object.create(_arrayAugmentations2.default);
                    }
                    oldValue = value;
                    if (deps.length > 0) {
                        /*有依赖者*/
    ...
    compile: function compile(htmlTxt) {
        ...
        try {
            for (var _iterator = matchTxt[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
exports.default = Object.create(FakeArray.prototype);
...
PubSub.prototype = {
    ...
    emit: function emit(eventType) {
        ...
        try {
            for (var _iterator = eventChain[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var _eventType = _step.value;

                if (self.handlers[_eventType]) {
                    for (var i = 0; i < self.handlers[_eventType].length; i++) {
                        self.handlers[_eventType][i].apply(self, handlerArgs);
                    }
                }
            }
        } catch (err) {
